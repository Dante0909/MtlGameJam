...
Oh! C’est vrai, je n’ai pas vu le temps passer *Rougit* #Joseph
...
*[Je ne m’attendais pas a se que tu te confies à moi… mais ce n’est pas une façon d’agir ainsi voyons!]
… # Pierre-Esprit
{GivePoints("P",0)}->choice_Pierre_Esprit_activity_two
*[Wow Pierre-Esprit je suis impressionnée! Je ne m’attendais pas à ce que tu te confies comme ça… Et que tu sois un si bon artisan. Ton secret est en sécurité avec moi.]
...
=== function GivePoints(character, points) ===
    {character == "J": J_points = J_points + 1}
    {character == "F": F_points = F_points + 1}
    {character == "P": P_points = P_points + 1}
    ~ return
